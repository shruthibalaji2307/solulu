...
qdrant_key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2Nlc3MiOiJtIiwiZXhwIjoxNzQyNDE5NjUwfQ.N29bUq3XvRJuUp-b2QKxAtt67G7pGBpPNY090TfnNMg"
qdrant_url = "https://f9aaaa60-fbce-4765-8732-bfae1f7afe6f.us-east4-0.gcp.cloud.qdrant.io:6333"
neo4j_uri = "neo4j+s://25783bde.databases.neo4j.io"
neo4j_username = "neo4j"
neo4j_password = "_yLFp-vNefPMZSUSsmz6KOhunTy3mN98oSNPOLdwkUw"
...
if __name__ == "__main__":
    ...
    raw_data = """Shiv Patel is our main persona. \
        He is a freshman in highschool. \
        He has interests in swimming, surfing, reading, playing chess, and volunteering activities. \
        He is a member of the school's chess club. \
        He is also a part of the school's volunteer club. \
        He is a member of the school's surfing team. \
        He is a member of the school's book club. \
        Shiv has 5 friends. \
        Meghan Miller loves swimming and is a member of the school's swimming team. She also wants to learn surfing.\
        Jayden Davis and Shiv are both interested in volunteering and doing things to help the environment.\
        Hana Nguyen, Shiv Iyer and Meghan Miller are ardent readers. Hana has a book club where they decide a book each week and discusses it with friends.\
        Leah Goldberg and Shiv are very good academically and are working together towards prepping college applications.\
        Gabriel Gonzalez and Shiv are part of the school's chess club and are preparing for the upcoming chess tournament.\
        """
    ...
    query = "Generate an event that Shiv Patel and Hana Nguyen can participate in together."
